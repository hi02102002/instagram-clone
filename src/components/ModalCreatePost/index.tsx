...
const ModalCreatePost: React.FC<Props> = ({ onClose }) => {
   ...
   const myElRef = useClickOutside(onClose);
         ...
         >
            {loading ? (
               ...
               <div>
                  ...
                  <div className="flex">
                     {imgPreview.length > 0 ? (
                        <div className=" w-full max-w-[495px] aspect-square flex-shrink-0 relative animate-fadeIn">
                           <img
                              src={imgPreview}
                              alt=""
                        ...
                        <div className="min-h-[495px] min-w-[495px] w-full max-w-[495px] flex flex-col items-center justify-center gap-y-6 animate-fadeIn">
                           <svg
