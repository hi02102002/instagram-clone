...
const Post: React.FC<Props> = ({ post, onRemove }) => {
   ...
   return (
      <div className="w-full bg-white rounded-t border border-solid border-border-color">
         ...
         <div className="h-header-height border-t rounded-b border-t-border-color border-solid bg-white px-5 flex items-center gap-x-3">
            <svg
               width="24"
               height="24"
               viewBox="0 0 24 24"
